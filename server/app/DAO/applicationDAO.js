...
async function createApplication(payload) {
    ...
    if (savedApplication) {
        ...
        for (const attachment_id of payload.attachments_Ids) {
            await AttachmentModel.updateMany(
                {_id: new mongoose.Types.ObjectId(attachment_id)},
        ...
        const updatedAttachments = await AttachmentModel.find({_id: {$in: payload.attachments_Ids}});
        const updatedDetails = await DetailsModel.find({_id: payload.details_Id});
